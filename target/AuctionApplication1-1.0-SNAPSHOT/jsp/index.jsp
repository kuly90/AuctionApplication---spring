                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    <li><a href="index?pages=1" class="active"><i class="glyphicon glyphicon-home"></i>  Home</a></li>
                    ...
                    <div class="col-sm-12">
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo1 text-center" >
                                                <a href="jsp/customer/viewAuction?id=${auctionNotFinish.auctionID}"><img src="resources/images/goods/${auctionNotFinish.goodsEntity.top1Image}" width="250" height="180" class="img-thumbnail" alt="" /></a>
                                                <h2>&dollar; ${auctionNotFinish.formattedMinimunPrice}</h2>
                                                <p style="min-height: 38px;">${auctionNotFinish.goodsEntity.goodName}</p>
                                                <a href="jsp/customer/viewAuction?id=${auctionNotFinish.auctionID}" class="btn btn-default add-to-cart" id="buttonHide<% out.print(i);%>"><i class="glyphicon glyphicon-usd"></i>Bids Now </a>
                        ...
                        <ul class="pagination">
                            <li><a href="">«</a></li>
                                ...
                                <li <c:if test="${active == i}">class="active"</c:if>><a href="index?pages=<c:out value="${i}"/>&pagesFN=${pagesFN}"><c:out value="${i}"/></a></li>
